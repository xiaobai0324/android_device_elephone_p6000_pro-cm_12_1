...
$(call inherit-product, device/elephone/p6000_pro/vendor/copyfiles.mk)
$(call inherit-product, vendor/elephone/p6000_pro/p6000_pro-vendor-blobs.mk)

LOCAL_PATH := device/elephone/p6000_pro
...
TARGET_OTA_ASSERT_DEVICE := p6000_pro
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ramdisk/ueventd.mt6735.rc:root/ueventd.rc \
